...
<footer className=" bg-blue-700  dark:bg-gray-900 ">
    ...
    <div className="px-4 py-6 bg-blue-800 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-white dark:text-gray-300 sm:text-center">© 2023 <Link to="https://flowbite.com/">Flowbite™</Link>. All Rights Reserved.
        </span>
